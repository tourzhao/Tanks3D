...
1,107 checks; four app-command executables add twenty-two suites and 115 checks,
so the aggregate gate runs 193 suites and 8,403 checks across fifteen profiles.
