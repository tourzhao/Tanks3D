...
1,107 checks; five app-layer executables add thirty suites and 154 checks, so
the aggregate gate runs 201 suites and 8,442 checks across sixteen profiles.
