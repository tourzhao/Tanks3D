...
1,107 checks; five app-layer executables add twenty-seven suites and 136 checks,
so the aggregate gate runs 198 suites and 8,424 checks across sixteen profiles.
